...
const Codedet = ({ selectedCodeDetails,handleCodeClick  }) => {
        ...
        <div>
          ...
          {selectedCodeDetails && (
            <table>
              ...
              <tbody>
                <tr key={selectedCodeDetails.code}>
                  <td>{selectedCodeDetails.code}</td>
                  <td>{selectedCodeDetails.longDescription}</td>
